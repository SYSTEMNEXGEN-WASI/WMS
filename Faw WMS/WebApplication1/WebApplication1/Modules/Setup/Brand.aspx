<%@ Page Title="" theme="Theme1" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="Brand.aspx.cs" Inherits="DXBMS.Modules.Setup.Brand" %>
                            ...
                            <div class="table-responsive">
                                ...
                                <table width="70%" style="border-collapse: separate; border-spacing: 5px;"
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style1">Brand Code </td>
                                        <td class="auto-style5">
                                            <asp:TextBox ID="txtBrandCode" runat="server" Height="21px" MaxLength="3" Width="200px" ReadOnly="true"></asp:TextBox><span>   (Auto Number)</span>
                                        </td>
                                        

                                    </tr>
                                    <tr>
                                        <td class="auto-style1">Brand Description <span style="color:red;">*</span></td>
                                        <td class="auto-style5">
                                            <asp:TextBox ID="txtBrandDesc" runat="server" Height="21px" MaxLength="50" Width="450px"></asp:TextBox>
                                        </td>
                                        ...
                                        <asp:GridView runat="server" ShowHeaderWhenEmpty="true" Width="100%" ID="gv_Brand" AutoGenerateColumns="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Brand Code">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblBrandCode" runat="server" Text='<%# Bind("BrandCode") %>'></asp:Label>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Brand Description">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblBrandDesc" runat="server" Text='<%# Bind("BrandDesc") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:TemplateField>
