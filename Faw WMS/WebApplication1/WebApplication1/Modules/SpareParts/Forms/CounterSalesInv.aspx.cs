...
namespace DXBMS.Modules.SpareParts.Forms
{
    public partial class CounterSalesInv : System.Web.UI.Page
    {
        ...
        private void Insert_MasterDetail()
        {
            ...
            try
            {
                  PartRequisition = SysFunc.GetStringValuesAgainstCodes("DealerCode", Session["DealerCode"].ToString(), "PartRequisition", "Dealer", Session["DealerCode"].ToString());
        ...
        protected void SelectedPartDetail(string item)
        {
            try
            {
                ...
                {
                    ddlCustomer.SelectedValue = item.ToString().Trim();
