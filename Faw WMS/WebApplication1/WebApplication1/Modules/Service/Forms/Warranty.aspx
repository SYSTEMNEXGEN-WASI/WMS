					...
					<table width="100%" style="border-collapse:separate; border-spacing:5px;" class="table table-condensed table-bordered table-hover">
					   ...
					   <%-- <tr>
						...
						<tr>
							...
							<td>
								<asp:TextBox ID="dtProblemDate" runat="server"
                                CssClass="ROTextBoxes"  Width="115px"
                                Style="background-image: url(../../../Images/Calendar_16x16.png); background-repeat: no-repeat; padding-left: 25px; width: 100%;" AutoComplete="off"></asp:TextBox>
							...
							<td>
								<asp:TextBox ID="dtComplitionDate" AutoComplete="off" runat="server"
                                CssClass="ROTextBoxes"  Width="115px"
                                Style="background-image: url(../../../Images/Calendar_16x16.png); background-repeat: no-repeat; padding-left: 25px; width: 100%;"></asp:TextBox>
						...
						<ContentTemplate>
							...
							<table width="100%" style=" border-collapse:separate; border-spacing:5px;" class="table table-condensed table-bordered table-hover">
								...
								<tr>
									...
									<td style="display:none;">Labor Description
