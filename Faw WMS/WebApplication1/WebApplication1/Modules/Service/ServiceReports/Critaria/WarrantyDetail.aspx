<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" Theme="Theme1" AutoEventWireup="true" CodeBehind="WarrantyDetail.aspx.cs" Inherits="DXBMS.Modules.Service.ServiceReports.Critaria.WarrantyDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
       <%-- <script src="../../../../js/jquery-3.2.1.min.js" type="text/javascript"></script>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div class="container">
                    <div class="Heading">WARRANTY  DETAIL REPORT</div>
                    <fieldset>
                                ...
                                <td  align="right">
                                    <asp:RadioButtonList ID="rbStatus" runat="server" RepeatDirection="Horizontal" Width="100%" AutoPostBack="true">
                                       <%-- <asp:ListItem Selected="True" Text="All" Value="All" />--%>
                                        <asp:ListItem  Selected="True" Text="HCV" Value="HCV" />
