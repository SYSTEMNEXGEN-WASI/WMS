    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <table width="100%" style="border-collapse:separate; border-spacing:5px;" class="table table-condensed table-bordered table-hover">
                ...
                <tr>
                    <td>
                        Customer *<asp:ImageButton runat="server" ID="ImageButtonCustomer" ImageUrl="~/Images/LookupNew.png" OnClick="ImageButtonCustomer_Click" Width="16px" AccessKey="i" CausesValidation="false" />
                    </td>
                    <td>
                        <asp:DropDownList ID="ddlCustomer" runat="server" Font-Names="monospace"  Width="83%">
                        </asp:DropDownList>
