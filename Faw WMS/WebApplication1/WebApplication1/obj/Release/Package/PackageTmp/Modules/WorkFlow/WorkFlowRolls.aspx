<%@ Page Title="" Theme="Theme1" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="WorkFlowRolls.aspx.cs" Inherits="DXBMS.Modules.WorkFlow.WorkFlowRolls" %>
                                ...
                                <table width="70%" style="border-collapse: separate; border-spacing: 5px;"
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style14">
                                            ...
                                            <asp:CalendarExtender runat="server" TargetControlID="txtValidFrom" Format="dd-MM-yyyy"></asp:CalendarExtender>
                                        </td>
                                        ...
                                        <td class="auto-style14">
                                            ...
                                            <asp:CalendarExtender runat="server" TargetControlID="txtValidTo" Format="dd-MM-yyyy"></asp:CalendarExtender>
                                        </td>
                                    </tr>
                                    <tr>
