...
public class JsonResponse : IHttpHandler, IRequiresSessionState 
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        foreach (DXBMS.Modules.CustomerExperience.CalendarEvent cevent in DXBMS.Modules.CustomerExperience.EventDAO.getEvents(start, end))
        {
    ...
    private String convertCalendarEventIntoString(DXBMS.Modules.CustomerExperience.CalendarEvent cevent)
    {
        String allDay = "true";
