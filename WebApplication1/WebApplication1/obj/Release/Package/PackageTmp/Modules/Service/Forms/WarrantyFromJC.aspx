<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" Theme="Theme1" AutoEventWireup="true" CodeBehind="WarrantyFromJC.aspx.cs" Inherits="DXBMS.Modules.Service.Forms.WarrantyFromJC" %>
                ...
                <table width="100%" style="border-collapse:separate; border-spacing:5px;" class="table table-condensed table-bordered table-hover">
                    <tr>
                        <td width="10%" align="right">
                            Billing No :<asp:ImageButton ID="ImageButton1" runat="server" Height="17px" ImageUrl="~/Images/LookupNew.png"
                            CausesValidation="false"    Width="17px" onclick="ImageButton1_Click1" />
                        </td>
                        <td style="width: 20%">
                         ...
                         style="width: 10%">
                            <asp:TextBox ID="txtBillingNo" runat="server" Width="90px" AutoPostBack="True" 
                                ...
                                ontextchanged="txtBillingNo_TextChanged" ReadOnly="True"></asp:TextBox>
                                <asp:DropDownList ID="ddlBillingNo" runat="server" AutoPostBack="True" style="width: 100% !important;" Visible="false"
                ...
                <table width=100% style="border-collapse:separate; border-spacing:5px;" class="table table-condensed table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td colspan="9">
                            ...
                            OnRowDataBound="Grdbillings_RowDataBound">
                                <Columns>
                                    <asp:TemplateField>
                                      <HeaderTemplate>
                ...
                <table width="100%" style="border-collapse:separate; border-spacing:5px;" class="table table-condensed table-bordered table-hover">
                    ...
                    <tr>
                     <td colspan="8" align="right"> 
                         ...
                         <td style="width: 8%">
                            <asp:TextBox ID="txtLaborAmount" runat="server" Width="80px"  CssClass="ROTextBoxes" style="text-align :right" CausesValidation="false" AutoPostBack="true" OnTextChanged="txtLaborAmount_TextChanged" >0</asp:TextBox>                            
                            <ajaxToolkit:FilteredTextBoxExtender
                             ID="FilteredTextBoxExtender5" runat="server" BehaviorID="_content_FilteredTextBoxExtender1"
                                                    FilterType="Custom"  ValidChars="01234567890." TargetControlID="txtLaborAmount" />
                        </td>
                     <td colspan="8" align="right"> 
                           Handling Amount :
                        </td>                        
                        <td style="width: 8%">
                            <asp:TextBox ID="txtHandlingAmt" runat="server" Width="80px"  CssClass="ROTextBoxes" CausesValidation="false" AutoPostBack="true" OnTextChanged="txtHandlingAmt_TextChanged" style="text-align :right">0</asp:TextBox>
                            <ajaxToolkit:FilteredTextBoxExtender
                                                    ID="FilteredTextBoxExtender1" runat="server" BehaviorID="_content_FilteredTextBoxExtender1"
                                                    FilterType="Custom"  ValidChars="01234567890." TargetControlID="txtHandlingAmt" />
                        </td>
                    ...
                    <tr>
                       <td colspan="8" align="right"> 
                         ...
                         <td style="width: 8%">
                            <asp:TextBox ID="txtLabPST" runat="server" Width="80px"  CssClass="ROTextBoxes" style="text-align :right" >0</asp:TextBox>                            
                            <ajaxToolkit:FilteredTextBoxExtender
                             ID="FilteredTextBoxExtender2" runat="server" BehaviorID="_content_FilteredTextBoxExtender1"
                                                    FilterType="Custom"  ValidChars="01234567890." TargetControlID="txtLabPST" />
                        </td>
                       <td colspan="8" align="right"> 
                           Part Amount :
                        </td>                        
                        <td style="width: 8%">
                            <asp:TextBox ID="txtPartAmount" runat="server" Width="80px" ReadOnly="true" CssClass="ROTextBoxes" style="text-align :right">0</asp:TextBox>
                             <ajaxToolkit:FilteredTextBoxExtender
                             ID="FilteredTextBoxExtender6" runat="server" BehaviorID="_content_FilteredTextBoxExtender1"
                                                    FilterType="Custom"  ValidChars="01234567890." TargetControlID="txtPartAmount" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 8%">
                            <asp:TextBox ID="txtGSTAmt" runat="server" Width="80px" ReadOnly="true" CssClass="ROTextBoxes" style="text-align :right">0</asp:TextBox>
                             <ajaxToolkit:FilteredTextBoxExtender
                             ID="FilteredTextBoxExtender4" runat="server" BehaviorID="_content_FilteredTextBoxExtender1"
                                                    FilterType="Custom"  ValidChars="01234567890." TargetControlID="txtGSTAmt" />
                        </td>                        
                        <td colspan="8" align="right">                            
                                        Total Amount:
                        </td>
                        <td align="left">
                               <asp:TextBox ID="txtTotalAmount" runat="server" Width="80px"  CssClass="ROTextBoxes" style="text-align :right">0</asp:TextBox>
                        <ajaxToolkit:FilteredTextBoxExtender
                             ID="FilteredTextBoxExtender3" runat="server" BehaviorID="_content_FilteredTextBoxExtender1"
                                                    FilterType="Custom"  ValidChars="01234567890." TargetControlID="txtTotalAmount" />
                        </td>
