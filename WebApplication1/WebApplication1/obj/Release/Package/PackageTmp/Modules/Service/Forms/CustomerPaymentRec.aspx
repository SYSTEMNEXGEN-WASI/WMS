<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerPaymentRec.aspx.cs" MaintainScrollPositionOnPostback="true"
    Inherits="DXBMS.Modules.Service.Forms.CustomerPaymentRec" MasterPageFile="~/Root.master"
    Theme="Theme1" %>
    ...
    <asp:UpdatePanel ID="UpdPanel1" runat="server">
        <ContentTemplate>
          ...
          <table width="100%" style="border-collapse:separate; border-spacing:5px;" class="table table-condensed table-bordered table-hover">
             ...
             <td>
                                        <asp:DropDownList ID="ddlInsCo" runat="server" AutoPostBack="True" Enabled="false"
