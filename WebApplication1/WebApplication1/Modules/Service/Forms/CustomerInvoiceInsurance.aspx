<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" Theme="Theme1" AutoEventWireup="true"
    CodeBehind="CustomerInvoiceInsurance.aspx.cs" Inherits="DXBMS.Modules.Service.CustomerInvoiceInsurance" %>
                    ...
                    <div class="col-lg-12">
                        ...
                        <fieldset style="width:100%;">
                            <table width="100%" style="border-collapse: separate; border-spacing: 5px;" class="table table-condensed table-bordered table-hover">
                                ...
                                <tr>
                                    <td>
                                    Invoice No.<asp:ImageButton runat="server" ID="ImageButtonInvNO" ImageUrl="~/Images/LookupNew.png" OnClick="ImageButtonInvNO_Click" Width="16px" AccessKey="i" />
                                    </td>
                                    <td>
                                    ...
                                    <td >
                                        <asp:TextBox ID="txtInvoiceDate" runat="server" ReadOnly="True" Style="background-image: url(../../../Images/Calendar_16x16.png); background-repeat: no-repeat; padding-left: 25px; width: 100%;"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td>
                                     Job Card<asp:ImageButton runat="server" ID="ImageButtonRoNO" AccessKey="j" ImageUrl="~/Images/LookupNew.png" OnClick="ImageButtonRoNO_Click" Width="16px" /> <font color="red"><b>*</b></font>
                                ...
                                <tr>
                                    <td>
                                    Customer<asp:ImageButton runat="server" ID="imgCustomerCode" CausesValidation="false" ImageUrl="~/Images/LookupNew.png" OnClick="imgCustomerCode_Click" /> <font color="red"><b>*</b></font>
                                    </td>
                                    <td>
                                    ...
                                    <td >
                                        <asp:TextBox ID="txtProductCode" runat="server" Width="100%" SkinID="ROTextBox"
                                ...
                                <tr>
                                    ...
                                    <td >
                                        <asp:TextBox ID="txtProductName" runat="server" Width="100%" SkinID="ROTextBox"
                ...
                <table width="100%" style="border-collapse: separate; border-spacing: 5px;" class="table table-condensed table-bordered table-hover">
                   <%-- Row 1 --%>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtDiscLabor" runat="server" MaxLength="4" onblur="CalcInvPartsDiscount()" TabIndex="7"
                                Width="60px"></asp:TextBox>
                             <asp:HiddenField ID="txthdnLabors" runat="server" 
                               ></asp:HiddenField>
                        </td>
                        ...
                        <td>
                            <asp:TextBox ID="txtTotalAmtCustomer" runat="server" ReadOnly="True" SkinID="ROTextBox"
                                Width="60px"></asp:TextBox>
                            <asp:HiddenField ID="txthdnTotalnet" runat="server"
                                ></asp:HiddenField>
                                  <asp:HiddenField ID="hdnTotalForCustomer" runat="server"
                                ></asp:HiddenField>
                        </td>
                    </tr>
                    <%-- Row 2 --%>
                 ...
                 <td>
                        ...
                        <td>
                            <asp:TextBox ID="txtDiscountParts" runat="server" onblur="CalcInvPartsDiscount()" TabIndex="8"
                                Width="60px" MaxLength="4"></asp:TextBox>
                            <asp:HiddenField ID="txthdnParts" runat="server"
                                ></asp:HiddenField>
                   ...
                   <%-- Row 4 --%>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtSubTotal" runat="server" ReadOnly="True" SkinID="ROTextBox" Width="60px"
                        ...
                        <td colspan="6">
                         <asp:GridView ID="gvTax" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvTax_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Type" HeaderText="Type" />
                                    <asp:BoundField DataField="Dep" HeaderText="Dep" Visible="false" />
                                    <asp:BoundField DataField="DepAmount" HeaderText="Dep Amount" />
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <asp:Button ID="btnDeleteInv" Width="100px" runat="server" Text="Delete" AccessKey="y" OnClick="btnDeleteInv_Click"
