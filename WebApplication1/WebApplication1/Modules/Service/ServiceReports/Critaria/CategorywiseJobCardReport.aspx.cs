...
{
    public partial class CategorywiseJobCardReport : System.Web.UI.Page
    {
        ...
        protected void btnShowReport_Click(object sender, EventArgs e)
        {
            ...
            string sql = "exec sp_JobCardDetailReport_Cateorywise '" + Session["DealerCode"].ToString() + "','" + FromDate.ToString("yyyy-MM-dd") + "','" + ToDate.ToString("yyyy-MM-dd") + "','" + rbStatus.SelectedItem.Value.ToString() + "','" + ddlAdvisorCode.SelectedValue + "', '"+ddlJobCardTypeCode.SelectedValue+"' ,'"+ddlJobCardTypeCategory.SelectedValue+"' ,'"+ddlSubCategory.SelectedValue+"' ";
            dt = myFunc.GetData(sql);
            RD.Load(Server.MapPath("../rptJobCardDateCategoryWise.rpt"));
            RD.OpenSubreport(Server.MapPath("../JobCardSummaryCategory.rpt"));
