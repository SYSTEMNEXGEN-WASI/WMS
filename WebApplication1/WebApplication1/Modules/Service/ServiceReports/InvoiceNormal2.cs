...
namespace DXBMS.Modules.Service.ServiceReports {
    ...
    public class InvoiceNormal2 : ReportClass {
        
        public InvoiceNormal2() {
        }
        
        public override string ResourceName {
            get {
                return "InvoiceNormal2.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "DXBMS.Modules.Service.ServiceReports.InvoiceNormal2.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedInvoiceNormal2 : Component, ICachedReport {
        
        public CachedInvoiceNormal2() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            InvoiceNormal2 rpt = new InvoiceNormal2();
            rpt.Site = this.Site;
            return rpt;
        }
