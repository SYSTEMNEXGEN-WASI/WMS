...
{
    public partial class WorkFlowPolicy : System.Web.UI.Page
    {
        ...
        //    string max2 = sysFuncs.AutoGen("WFPolicyMaster", "WFPolicyMasterCode", Session["DealerCode"].ToString(), DateTime.Parse(DateTime.Now.ToShortDateString()).ToString("dd/MM/yyyy"));
        //    SqlParameter[] param =
        //   {
        //                    new SqlParameter("@DealerCode",SqlDbType.Char,5),//0
        //                    new SqlParameter("@WFPolicyMasterID",SqlDbType.Char,4), //1
        //                    new SqlParameter("@WFPolicyMasterCode",SqlDbType.Char,8),//2
        //                    new SqlParameter("@WFPolicyMasterDesc",SqlDbType.VarChar,30), //3
        //                    new SqlParameter("@Solution_Code",SqlDbType.Char,4), //4
        //                    new SqlParameter("@PolicyType",SqlDbType.VarChar,30), //5
        //                    new SqlParameter("@PolicyStartDate",SqlDbType.DateTime), //6
        //                    new SqlParameter("@PolicyEndDate",SqlDbType.DateTime), //7
        //                    new SqlParameter("@Status",SqlDbType.VarChar,15), //8
        //                    new SqlParameter("@Comments",SqlDbType.VarChar,50), //9
        //                    new SqlParameter("@DelFlag",SqlDbType.Char,1), //9
        ...
        //    param[1].Value = max1;
        //    param[2].Value = max2;
        //    param[3].Value = txt.Text.Trim();
        //    param[4].Value = ddlSolution.Text.Trim();
