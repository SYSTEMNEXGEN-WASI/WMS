<%@ Page Title="" Theme="Theme1" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="WorkFlowPolicyMaster.aspx.cs" Inherits="DXBMS.Modules.SpareParts.Forms.WorkFlowPolicyMaster" %>
                                ...
                                <table width="70%" style="border-collapse: separate; border-spacing: 5px;"
                                    ...
                                    <tr>
                                        ...
                                        <td class="auto-style14">
                                            ...
                                            <asp:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtStartDate" Format="dd-MM-yyyy"></asp:CalendarExtender>
                                        </td>
                                        ...
                                        <td class="auto-style14">
                                            ...
                                            <asp:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtEndDate" Format="dd-MM-yyyy"></asp:CalendarExtender>
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <table width="70%" style="border-collapse: separate; border-spacing: 5px;"
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style13">
                                         <asp:Button ID="btnSave1" runat="server"  Text="Save" Width="100px" OnClick="btnSave1_Click" />
                                        <asp:Button ID="btnCLear0" runat="server" Height="30px" Text="Clear" Width="100px" OnClick="btnClear0_Click" />
                                        <%--<asp:Button ID="btnPrint" runat="server" Height="30px" Text="Print" Width="100px" OnClick="btnPrint_Click" />--%>
