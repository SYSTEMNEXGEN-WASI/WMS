<%@ Page Title="" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="GRNDetailReport.aspx.cs" Inherits="DXBMS.Modules.Reports.GRNDetailReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
    <center>
            <div class="Heading">PARTS RECEIPT (GRN DETAIL REPORT)</div>
