<%@ Page Title="" Theme="Theme1" Language="C#" MasterPageFile="~/Root.master" AutoEventWireup="true" CodeBehind="VendorLedgerReport.aspx.cs" Inherits="DXBMS.Modules.SpareParts.SpareReports.Critaria.VendorLedgerReport" %>
        ...
        <ContentTemplate>
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <fieldset>
                            <legend>Vendor Ledger Report</legend>
                            <div >
                                ...
                                <table width="100%" style="border-collapse: separate; border-spacing: 5px;"
                                    ...
                                    <tr>
                                        <td align="right" width="50%">Vendor
                                        </td>

                                        <td >
                                            <asp:DropDownList ID="ddlVendorCode" runat="server" Width="234px" >
                                            </asp:DropDownList>
                            ...
                            background-repeat: no-repeat; padding-left: 25px; width: 100%;"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="btnShow" runat="server"  Text="Show Detail" Width="200px" OnClick="btnShow_Click" />
                                        </td>                                        
                                    </tr>
                                </table>
                            </div>
