    ...
    public partial class TaxType : System.Web.UI.Page
    {
        ...
        protected void gv_TaxType_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                string sql = "update TaxType set TaxHead = '" + txtTaaxHead.Text + "',Type='" + ddlEditType.Text + "',TaxApplicable='" + ddlEditTaxApplicable + "',TaxPer='" + txtEditPer + "'  WHERE TaxID='" + lblTaxID.Text + "'  ";
